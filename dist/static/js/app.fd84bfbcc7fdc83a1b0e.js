                ...
                switch (_c.label) {
                    ...
                    case 13:
                        for (address in arr) {
                            if (arr.hasOwnProperty(address)) {
                                value_2 = arr[address];
                                for (asset in value_2) {
                                    if (value_2.hasOwnProperty(asset)) {
                                        amount = value_2[asset];
                                        history = new entity_1.History();
                                        history.time = time;
                                        history.txid = txid;
                                        history.assetname = asset;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-8b59b822","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/pages/transfer.vue
